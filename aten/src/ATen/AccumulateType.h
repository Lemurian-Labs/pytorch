...
template <> struct AccumulateType<c10::CFloatWithSubnormals, true> { using type = float; };
template <> struct AccumulateType<c10::LNS16, true> { using type = float; };
...
template <> struct AccumulateType<c10::LNS16, false> { using type = float; };
