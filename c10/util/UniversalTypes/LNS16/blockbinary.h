...
// blockbinary
template C10_HOST_DEVICE LNS16BlockBinary::blockbinary<LNS16ExponentBlockBinary::nbits>(const LNS16ExponentBlockBinary& rhs);
...
template C10_HOST_DEVICE LNS16BlockBinary& LNS16BlockBinary::operator=(long long rhs) noexcept;
template C10_HOST_DEVICE LNS16BlockBinary::bt LNS16BlockBinary::block(size_t b) const noexcept;
