...
template CUDA_NOINLINE C10_HOST_DEVICE sw::universal::LNS16 numeric_limits<sw::universal::LNS16>::max();
template CUDA_NOINLINE C10_HOST_DEVICE sw::universal::LNS16 numeric_limits<sw::universal::LNS16>::epsilon();
